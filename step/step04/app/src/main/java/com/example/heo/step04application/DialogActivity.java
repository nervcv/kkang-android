package com.example.heo.step04application;
...
public class DialogActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v == alertBtn) {
            ...
            progressDialog.setIndeterminate(true); // 계속 진행
            // progressDialog.setProgressPercentFormat(); // 기본으로 몇 퍼센트 진행인지 출력
            // progressDialog.setProgressNumberFormat(); // 진행 상태를 나타내는 숫자 값의 형식을 지정
